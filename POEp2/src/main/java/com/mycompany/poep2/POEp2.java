...
public class POEp2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("");
        int totalSent = 0;
        //until user selects quit the loop will runs
        while (!quit) {
            ...
            switch (selectedChoice) {
                ...
                case "1":
                    ...
                    for (int i = 0; i < numMessages; i++) {
                        ...
                        //It creates a new instance of the Message class in memory named msg and initializes it by passing the current sequential msgNumber into its constructor.
