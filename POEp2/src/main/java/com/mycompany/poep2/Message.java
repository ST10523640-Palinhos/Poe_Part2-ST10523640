...
public class Message {
    ...
    //It creates a private, dynamically resizing list that is strictly restricted to storing String objects and can only be accessed within the Message class.
    ...
    public Message(int inMessageNumber) {
        ...
        // creates a 10 digit ID for the message
    ...
    //method to save message to a json files
    public void storeMessage() {
        ...
        try (FileWriter fw = new FileWriter("messages.json", true)) {
            ...
            //A catch block is a protective code section that intercepts a specific runtime error thrown by an preceding try block, allowing the program to handle the issue gracefully instead of crashing.
